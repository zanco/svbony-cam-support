#!/usr/bin/env python3
# STVID/SVBONY V31 experimental acquisition bridge.
...
def _load_svb_native():
    ...
    for _name in _svb_candidates:
        try:
            ...
            # The native library exposes these lifecycle functions, but V31 does not use
...
class SVBToASIBridge:
    ...
    def __init__(self, requested_width, requested_height, exposure_us, gain):
        ...
        # Use the frame dimensions requested by STVID/configuration.ini.
        ...
        # Exposure and gain come from the same configuration.ini used by STVID.
        ...
        # Native ctypes is not a second camera driver in V31.
    ...
    def close(self):
        ...
        # The native lifecycle API is intentionally not part of V31 camera ownership.
        try:
...
def _v23_capture_one_buffer(buf, zbase, tbase, nx, ny, nz, conf_file, sequence):
    ...
    # Read exposure and gain from the same configuration.ini used by STVID.
    ...
    try:
        ...
        # already been applied from configuration.ini by the bridge itself.
...
if __name__ == '__main__':
    ...
    # Read the device identifier from the selected camera section.
