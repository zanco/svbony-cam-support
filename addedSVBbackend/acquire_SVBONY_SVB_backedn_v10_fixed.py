...
def _v23_capture_one_buffer(buf, zbase, tbase, nx, ny, nz, conf_file, sequence, camera_serial):
    ...
    try:
        while time.time() < tend:
            ...
            worker = multiprocessing.Process(
                ...
                args=(buf, zbase, tbase, nx, ny, nz, conf_file, buffer_sequence, camera_serial)
            )
            worker.start()
            worker.join()
